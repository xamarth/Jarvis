...
from .. import LOGS, asst, udB, jarvis_bot
from ..fns.admins import admin_check
from . import append_or_update, owner_and_sudos

OWNER = jarvis_bot.full_name

MSG = f"""
**Jarvis - UserBot**
➖➖➖➖➖➖➖➖➖➖
**Owner**: [{OWNER}](tg://user?id={jarvis_bot.uid})
**Support**: @MyJarvis
➖➖➖➖➖➖➖➖➖➖
"""
...
IN_BTTS = [
    [
        Button.url(
            "Repository",
            url="https://github.com/btworeo/Jarvis",
        ),
        Button.url("Support", url="https://t.me/JarvisSupportChat"),
    ]
]
...
def callback(data=None, from_users=[], admins=False, owner=False, **kwargs):
    ...
    if "me" in from_users:
        ...
        from_users.append(jarvis_bot.uid)
                ...
                res = [
                    await event.builder.article(
                        ...
                        thumb=InputWebDocument(
                            "https://raw.githubusercontent.com/btwOreO/JarvisMedia/refs/heads/main/img3.jpg",
                            0,
                            "image/jpeg",
                            [],
                        ),
                    ...
                    await event.answer(
                        [
                            await event.builder.article(
                                ...
                                text=error_text(),
                                buttons=Button.url(
                                    "Report", "https://t.me/JarvisSupportChat"
                                ),
                            )
                        ]
                    )
